	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li class="nav-item">
					<a class="nav-link" href="{{url('login')}}" onclick="event.preventDefault(); document.getElementById('login-form').submit();"><i class="fa fa-power-off fa-1x" aria-hidden="true"></i></a> 
					<form id="login-form" action="{{url('login')}}" method="GET" style="display: none;">
					{{csrf_field()}}
					</form>
				</li>
